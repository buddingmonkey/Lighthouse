...
typedef enum talk_pic_e {
    ...
    ZOOMBOX_SPRITE_5D_XMAS_GIFT_RED,
    ZOOMBOX_SPRITE_5E_KLUNGO,
    ZOOMBOX_SPRITE_5F_SEXY_GRUNTY,
    ZOOMBOX_SPRITE_60_TOOTY_4,
    ZOOMBOX_SPRITE_61_BANJO_3,
    ZOOMBOX_SPRITE_62_KAZOOIE_3,
    ZOOMBOX_SPRITE_63_TOOTY_5,
    ZOOMBOX_SPRITE_64_DINGPOT,
    ZOOMBOX_SPRITE_65_CROC_BANJO,
    ZOOMBOX_SPRITE_66_GRUNTILDA_4,
    ZOOMBOX_SPRITE_67_LOCKUP,
    ZOOMBOX_SPRITE_68_VILE_5,
    ZOOMBOX_SPRITE_69_VILE_6,
    ZOOMBOX_SPRITE_6A_VILE_7
}GcZoomboxSprite;
...
void gczoombox_free(GcZoombox *self);
void gczoombox_func_803160A8(GcZoombox *self);
void func_803163A8(GcZoombox *self, Gfx **gfx, Mtx **mtx);
void func_803164B0(GcZoombox *self, Gfx **gfx, Mtx **mtx, s32 arg3, s32 arg4, BKSpriteDisplayData *arg5, f32 arg6);
void func_80316764(GcZoombox *self, s32 arg1);
void gczoombox_draw(GcZoombox *self, Gfx **gdl, Mtx ** mptr, void *vptr);
void func_80316E08(GcZoombox *self);
void func_80316E60(GcZoombox *self);
void func_80316E84(GcZoombox *self, s32 arg1);
s32 gczoombox_strlen(u8 *arg0);
void gczoombox_update(GcZoombox *self);
GcZoombox *gczoombox_new(s32 arg0, GcZoomboxSprite portrait_id, s32 arg2, s32 arg3, void (*arg4)(s32, s32));
bool gczoombox_setStrings(GcZoombox *self, s32 str_cnt, char **str_ptrs);
bool func_803183A4(GcZoombox *self, char *arg1);
void gczoombox_open(GcZoombox *self);
void gczoombox_close(GcZoombox *self);
void gczoombox_maximize(GcZoombox *self);
void gczoombox_minimize(GcZoombox *self);
void func_8031842C(GcZoombox *self);
void func_8031843C(GcZoombox *self);
void func_80318478(GcZoombox *self);
void func_80318488(GcZoombox *self);
void func_80318498(GcZoombox *self);
void gczoombox_resolve_minimize(GcZoombox *self);
void func_803184B8(GcZoombox *self);
void gczoombox_func_803184C8(GcZoombox *self, f32 arg1, s32 arg2, s32 arg3, f32 arg4, bool arg5, bool arg6);
bool func_8031857C(GcZoombox *self, u8 *str);
void gczoombox_highlight(GcZoombox *self, bool arg1);
bool gczoombox_is_highlighted(GcZoombox *self);
void func_80318614(GcZoombox *self, int arg1);
void func_80318640(GcZoombox *self, s32 arg1, f32 arg2, f32 arg3, s32 arg4);
void func_80318734(GcZoombox *self, f32 arg1);
void func_80318760(GcZoombox *self, s32 arg1);
void gczoombox_setUnk13ATo0(GcZoombox *self);
bool func_8031877C(GcZoombox *self);
bool func_803188B4(GcZoombox *self);
bool func_80318964(GcZoombox *self);
bool gczoombox_loadSprite(GcZoombox *self, GcZoomboxSprite arg1);
void func_80318B7C(GcZoombox *self, s32 arg1);
bool func_80318BEC(GcZoombox *self);
void gczoombox_defrag(GcZoombox *self);
void gczoombox_func_80318C48(GcZoombox *self, bool arg1);
